...
symbian:TARGET.UID3 = 0xE00D1DD7
...
SOURCES += main.cpp resourcehandler.cpp \
    settings.cpp
HEADERS += resourcehandler.h \
    settings.h

# needed for resource policy framework
...
OTHER_FILES += \
    ...
    qtc_packaging/debian_harmattan/circuittimer.postinst \
    circuittimer.conf
